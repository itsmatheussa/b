    ...
    <main className="space-bg min-h-screen bg-background">
      <div className="mx-auto max-w-xl px-5 py-14">
        ...
        <div className="surface-card mt-8 space-y-3 rounded-3xl p-6">
          ...
          <a
            href="https://promptsilimitados12.lovable.app/"
            target="_blank"
            rel="noopener noreferrer"
            className="btn-gold mt-2 block rounded-xl px-6 py-3.5 text-center text-sm font-bold hover:scale-[1.01]"
          >
            Acessar os 40 prompts restantes
          </a>
        </div>
