...
const TITLE = "Oferta — Ebook Completo";
const DESC =
  "Acesso vitalício ao ebook completo por R$12,99. Pagamento via PIX com liberação imediata.";
...
const INCLUDES = [
  ...
  "Fluxo de trabalho com IA para acelerar suas entregas",
