...
const DESC =
  "Assista à aula e descubra o método completo para criar e vender sites profissionais usando IA e a extensão Lovable.";
...
const REVIEWS = [
  ...
  },
  {
    name: "Camila S.",
    role: "Designer",
    text: "A extensão do Lovable mudou meu fluxo. Entrego em horas o que antes levava dias.",
  },
  {
    name: "Lucas P.",
    role: "Iniciante",
      ...
      <div className="mx-auto max-w-4xl px-5 py-12 md:py-16">
        <div className="text-center">
          ...
          <h1 className="mt-6 text-3xl font-extrabold leading-tight md:text-5xl">
            Crie e venda{" "}
            <span className="text-gold-sheen relative inline-block">
              sites profissionais
            </span>{" "}
            com IA mesmo começando do zero
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-base text-muted-foreground md:text-lg">
            Assista ao vídeo abaixo até o final e descubra o método completo que já colocou
            centenas de criadores no mercado.
          </p>
        </div>

        <div className="surface-card mt-10 overflow-hidden rounded-2xl p-2">
